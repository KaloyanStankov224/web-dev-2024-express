...
import { SubjectModel } from './subjects/subjects';
...
db.models.Subject.belongsToMany(db.models.User, { through: 'UserSubjects', as: 'users' })
db.models.User.belongsToMany(db.models.Subject, { through: 'UserSubjects', as: 'subjects' })
